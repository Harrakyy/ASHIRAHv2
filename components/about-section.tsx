      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white leading-tight mb-8 text-balance">
              Built on Dedication to{" "}
              <span style={{ color: '#D4AF37' }}>Quality Excellence</span>
            </h2>

            <div className="space-y-6 text-white/70 leading-relaxed">
              <p>
                <strong className="text-white">ASHIRA&apos;H.CO (PT. ASHIRA NIAGA INDONESIA)</strong> is a 
            ...
            <div className="mt-8 flex flex-wrap gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Grand Batavia Arcade, Tangerang</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#D4AF37]/10 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Nationwide Indonesia</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10 pt-8 border-t border-white/10">
              <p className="text-sm text-white/70 mb-2">Best regards,</p>
              <p className="font-serif text-xl text-white">Hawari Muttaqin Mafaza</p>
              <p className="text-sm text-white/70">Owner & Founder, ASHIRA GROUP</p>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center">
            <Image
              src="/images/ashira-corporate-logo-removebg-preview.png"
